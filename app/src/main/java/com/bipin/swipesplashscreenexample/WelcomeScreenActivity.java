        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(
                        WelcomeScreenActivity.this, MainActivity.class));            }
        });
            ...
            switch (position) {
                case 0:
                    welcomeScreenFragment = WelcomeScreenFragment
                            .newInstance(R.layout.fragment_welcome_screen1);
                    break;
                case 1:
                    welcomeScreenFragment = WelcomeScreenFragment
                            .newInstance(R.layout.fragment_welcome_screen2);
                    break;
                case 2:
                    welcomeScreenFragment = WelcomeScreenFragment
                            .newInstance(R.layout.fragment_welcome_screen3);
                    break;
                case 3:
                    welcomeScreenFragment = WelcomeScreenFragment
                            .newInstance(R.layout.fragment_welcome_screen4);
                    break;
